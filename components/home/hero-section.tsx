...
export function HeroSection() {
    return (
        <section className="relative grid pb-20 pt-10 lg:min-h-185.25 lg:grid-cols-[1fr_25.5625rem] lg:items-start">
            <div className="max-w-220 flex flex-col gap-40">
                <div className="">
                    <h1 className="text-[3.5rem] font-extrabold uppercase leading-[0.98] tracking-[-0.012em] text-[#FAFAF9] sm:text-8xl lg:text-[10.75rem]">
                        workout
                        <br />
                        with me
                    </h1>
                    <p className="mt-8 max-w-140 text-base leading-6 tracking-[0.03125em] text-[#efede8a6]">
                        A huge selection of health and fitness content, healthy
                        recipes and transformation stories to help you get fit and
                        stay fit.
                    </p>
                    <button className="mt-12 rounded-[0.625rem] bg-[#E6533C] px-6.25 py-6 text-[1.125rem] font-semibold leading-[1.222] tracking-[0.0555em] text-white transition hover:opacity-90">
                        Join Club Now!
                    </button>
                </div>
                <FeaturedInSection />
            ...
            <div className="relative lg:-ml-40 w-full max-w-102.25">
                <div className="overflow-hidden rounded-xl pt-16">
                    <Image
                ...
                <div className="absolute top-9 -right-15 h-27.5 w-45 rounded-xl bg-[#EF8964]">
                    <div className="flex flex-col gap-3 h-full w-full px-6.5 pt-3.5">
                        <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#EFA082]" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <g clip-path="url(#clip0_576_24495)">
                        ...
                        <div className="flex gap-2 items-end">
                            <p className="text-5xl font-bold uppercase leading-[1.04] tracking-[-0.104em] text-[#FAFAF9]">
                                4,95
                            </p>
                            <p className="text-base font-semibold leading-6 tracking-[0.03125em] text-[#efede8a6]">
                                km
                            </p>
                        </div>
                    </div>
                ...
                <div className="absolute -left-28 bottom-52 h-24 w-51.5 rounded-xl bg-[#303030]">
                    <div className="flex h-full items-center gap-3 px-5.75">
                        <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#EF8963] text-white">
                        ...
                        <div>
                            <p className="text-2xl font-semibold leading-none tracking-[0.0125em] text-[#FAFAF9]">
                                350+
                            </p>
                            <p className="mt-2 text-base leading-6 tracking-[0.03125em] text-[#efede8a6]">
                                Video tutorial
                            </p>
                        </div>
                    </div>
                ...
                <div className="absolute bottom-31 -right-33 h-24.5 w-48.25 rounded-xl bg-[#7A29DC] px-5 py-4.25">
                    <p className="text-[2.5rem] font-semibold leading-none tracking-[0.025em] text-[#FAFAF9]">
                        500+
                    </p>
                    <p className="mt-1.25 text-[0.8125rem] leading-5 tracking-[0.0769em] text-[#efede8a6]">
                        Free Workout Videos
                    </p>
                </div>
            </div>
